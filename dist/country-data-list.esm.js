...
const allTimezones = Object.values(timezoneData)
  .flat()
 ...
 */
function getCountriesForTimezone(timezone) {
  if (!timezone) return [];
...
export { callingCodes, callingCountries, continents, countries, currencies, currencySymbolMap, getNameFromCurrency, getSafeNameFromCurrency, getSafeSymbolFromCurrency, getSymbolFromCurrency, languages, lookup, regions, timezones };
